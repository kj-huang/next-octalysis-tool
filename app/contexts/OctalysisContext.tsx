...
export const OctalysisProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [data, setData] = useState<CoreDrivesData>({
    CD1: {
      title: 'CD1: Epic meaning & Calling',
      score: 5,
      coreDriveDescription: {
        paragraph: '{"root":{"children":[{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":"Core Drive notes & ideas","type":"text","version":1}],"direction":"ltr","format":"","indent":0,"type":"paragraph","version":1,"textFormat":0,"textStyle":""}],"direction":"ltr","format":"","indent":0,"type":"root","version":1}}',
        xPos: 400,
        yPos: 10,
        width: 200,
        height: 150,
  ...
  return <OctalysisContext.Provider value={{ projectName, data, updateCoreDrivesScore, updateProjectName, updateCoreDriveDescription }}>{children}</OctalysisContext.Provider>;
};
